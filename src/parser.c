...
enum ts_symbol_identifiers {
  ...
  anon_sym_EQ = 2,
  anon_sym_font_DASHfamily = 3,
  anon_sym_font_DASHfamily_DASHbold = 4,
  anon_sym_font_DASHfamily_DASHitalic = 5,
  anon_sym_font_DASHfamily_DASHbold_DASHitalic = 6,
  anon_sym_font_DASHstyle = 7,
  anon_sym_font_DASHstyle_DASHbold = 8,
  anon_sym_font_DASHstyle_DASHitalic = 9,
  anon_sym_font_DASHstyle_DASHbold_DASHitalic = 10,
  anon_sym_font_DASHsynthetic_DASHstyle = 11,
  anon_sym_font_DASHfeature = 12,
  anon_sym_font_DASHsize = 13,
  anon_sym_font_DASHvariation = 14,
  anon_sym_font_DASHvariation_DASHbold = 15,
  anon_sym_font_DASHvariation_DASHitalic = 16,
  anon_sym_font_DASHvariation_DASHbold_DASHitalic = 17,
  anon_sym_font_DASHcodepoint_DASHmap = 18,
  anon_sym_font_DASHthicken = 19,
  anon_sym_adjust_DASHcell_DASHwidth = 20,
  anon_sym_adjust_DASHcell_DASHheight = 21,
  anon_sym_adjust_DASHfont_DASHbaseline = 22,
  anon_sym_adjust_DASHunderline_DASHposition = 23,
  anon_sym_adjust_DASHunderline_DASHthickness = 24,
  anon_sym_adjust_DASHstrikethrough_DASHposition = 25,
  anon_sym_adjust_DASHstrikethrough_DASHthickness = 26,
  anon_sym_adjust_DASHoverline_DASHposition = 27,
  anon_sym_adjust_DASHoverline_DASHthickness = 28,
  anon_sym_adjust_DASHcursor_DASHthickness = 29,
  anon_sym_adjust_DASHcursor_DASHheight = 30,
  anon_sym_adjust_DASHbox_DASHthickness = 31,
  anon_sym_grapheme_DASHwidth_DASHmethod = 32,
  anon_sym_freetype_DASHload_DASHflags = 33,
  anon_sym_theme = 34,
  anon_sym_background = 35,
  anon_sym_foreground = 36,
  anon_sym_selection_DASHforeground = 37,
  anon_sym_selection_DASHbackground = 38,
  anon_sym_selection_DASHinvert_DASHfg_DASHbg = 39,
  anon_sym_minimum_DASHcontrast = 40,
  anon_sym_palette = 41,
  anon_sym_cursor_DASHcolor = 42,
  anon_sym_cursor_DASHinvert_DASHfg_DASHbg = 43,
  anon_sym_cursor_DASHopacity = 44,
  anon_sym_cursor_DASHstyle = 45,
  anon_sym_cursor_DASHstyle_DASHblink = 46,
  anon_sym_cursor_DASHtext = 47,
  anon_sym_cursor_DASHclick_DASHto_DASHmove = 48,
  anon_sym_mouse_DASHhide_DASHwhile_DASHtyping = 49,
  anon_sym_mouse_DASHshift_DASHcapture = 50,
  anon_sym_mouse_DASHscroll_DASHmultiplier = 51,
  anon_sym_background_DASHopacity = 52,
  anon_sym_background_DASHblur_DASHradius = 53,
  anon_sym_unfocused_DASHsplit_DASHopacity = 54,
  anon_sym_unfocused_DASHsplit_DASHfill = 55,
  anon_sym_command = 56,
  anon_sym_initial_DASHcommand = 57,
  anon_sym_wait_DASHafter_DASHcommand = 58,
  anon_sym_abnormal_DASHcommand_DASHexit_DASHruntime = 59,
  anon_sym_scrollback_DASHlimit = 60,
  anon_sym_link = 61,
  anon_sym_link_DASHurl = 62,
  anon_sym_fullscreen = 63,
  anon_sym_title = 64,
  anon_sym_class = 65,
  anon_sym_x11_DASHinstance_DASHname = 66,
  anon_sym_working_DASHdirectory = 67,
  anon_sym_keybind = 68,
  anon_sym_window_DASHpadding_DASHx = 69,
  anon_sym_window_DASHpadding_DASHy = 70,
  anon_sym_window_DASHpadding_DASHbalance = 71,
  anon_sym_window_DASHpadding_DASHcolor = 72,
  anon_sym_window_DASHvsync = 73,
  anon_sym_window_DASHinherit_DASHworking_DASHdirectory = 74,
  anon_sym_window_DASHinherit_DASHfont_DASHsize = 75,
  anon_sym_window_DASHdecoration = 76,
  anon_sym_window_DASHtitle_DASHfont_DASHfamily = 77,
  anon_sym_window_DASHtheme = 78,
  anon_sym_window_DASHcolorspace = 79,
  anon_sym_window_DASHheight = 80,
  anon_sym_window_DASHwidth = 81,
  anon_sym_window_DASHsave_DASHstate = 82,
  anon_sym_window_DASHstep_DASHresize = 83,
  anon_sym_window_DASHnew_DASHtab_DASHposition = 84,
  anon_sym_resize_DASHoverlay = 85,
  anon_sym_resize_DASHoverlay_DASHposition = 86,
  anon_sym_resize_DASHoverlay_DASHduration = 87,
  anon_sym_focus_DASHfollows_DASHmouse = 88,
  anon_sym_clipboard_DASHread = 89,
  anon_sym_clipboard_DASHwrite = 90,
  anon_sym_clipboard_DASHtrim_DASHtrailing_DASHspaces = 91,
  anon_sym_clipboard_DASHpaste_DASHprotection = 92,
  anon_sym_clipboard_DASHpaste_DASHbracketed_DASHsafe = 93,
  anon_sym_image_DASHstorage_DASHlimit = 94,
  anon_sym_copy_DASHon_DASHselect = 95,
  anon_sym_click_DASHrepeat_DASHinterval = 96,
  anon_sym_config_DASHfile = 97,
  anon_sym_config_DASHdefault_DASHfiles = 98,
  anon_sym_confirm_DASHclose_DASHsurface = 99,
  anon_sym_quit_DASHafter_DASHlast_DASHwindow_DASHclosed = 100,
  anon_sym_quit_DASHafter_DASHlast_DASHwindow_DASHclosed_DASHdelay = 101,
  anon_sym_initial_DASHwindow = 102,
  anon_sym_quick_DASHterminal_DASHposition = 103,
  anon_sym_quick_DASHterminal_DASHscreen = 104,
  anon_sym_quick_DASHterminal_DASHanimation_DASHduration = 105,
  anon_sym_quick_DASHterminal_DASHautohide = 106,
  anon_sym_shell_DASHintegration = 107,
  anon_sym_shell_DASHintegration_DASHfeatures = 108,
  anon_sym_osc_DASHcolor_DASHreport_DASHformat = 109,
  anon_sym_vt_DASHkam_DASHallowed = 110,
  anon_sym_custom_DASHshader = 111,
  anon_sym_custom_DASHshader_DASHanimation = 112,
  anon_sym_macos_DASHnon_DASHnative_DASHfullscreen = 113,
  anon_sym_macos_DASHtitlebar_DASHstyle = 114,
  anon_sym_macos_DASHtitlebar_DASHproxy_DASHicon = 115,
  anon_sym_macos_DASHoption_DASHas_DASHalt = 116,
  anon_sym_macos_DASHwindow_DASHshadow = 117,
  anon_sym_macos_DASHauto_DASHsecure_DASHinput = 118,
  anon_sym_macos_DASHsecure_DASHinput_DASHindication = 119,
  anon_sym_macos_DASHicon = 120,
  anon_sym_macos_DASHicon_DASHframe = 121,
  anon_sym_macos_DASHicon_DASHghost_DASHcolor = 122,
  anon_sym_macos_DASHicon_DASHscreen_DASHcolor = 123,
  anon_sym_linux_DASHcgroup = 124,
  anon_sym_linux_DASHcgroup_DASHmemory_DASHlimit = 125,
  anon_sym_linux_DASHcgroup_DASHprocesses_DASHlimit = 126,
  anon_sym_linux_DASHcgroup_DASHhard_DASHfail = 127,
  anon_sym_gtk_DASHsingle_DASHinstance = 128,
  anon_sym_gtk_DASHtitlebar = 129,
  anon_sym_gtk_DASHtabs_DASHlocation = 130,
  anon_sym_adw_DASHtoolbar_DASHstyle = 131,
  anon_sym_gtk_DASHwide_DASHtabs = 132,
  anon_sym_gtk_DASHadwaita = 133,
  anon_sym_desktop_DASHnotifications = 134,
  anon_sym_bold_DASHis_DASHbright = 135,
  anon_sym_term = 136,
  anon_sym_enquiry_DASHresponse = 137,
  anon_sym_auto_DASHupdate = 138,
  anon_sym_auto_DASHupdate_DASHchannel = 139,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [20] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__line, 3),
  [22] = {.entry = {.count = 1, .reusable = true}},  ACCEPT_INPUT(),
  [24] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 1),
  [26] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_keyword, 1),
  ...
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 5),
};
...
TS_PUBLIC const TSLanguage *tree_sitter_ghostty() {
